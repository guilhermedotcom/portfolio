...
<div class="collapse navbar-collapse" id="navbarSite">
	...
	echo verificarMsg();
	?>
<div class="p-2 mb-2 alert alert-danger text-center rounded">Área dedicada a exclusão de usuários:</div>
	...
	if ($linhas > 0) 
	{
		echo '<h6 class="alert alert-info">Usuários Cadastrados: (Área de Gerenciamento)</h6>';
		...
		while ($registros = mysqli_fetch_assoc($result)) //$result a tabela inteira, $registos vira uma linha da tabela.
		{
			...
			echo '<a href="deletar.php?id='.$id.'"onclick="return confirm(\'Deseja excluir este usuário?\')"class="btn btn-danger">Deletar</a>';
	...
	{
		echo "<h6 class='alert alert-info'>Não há contatos cadastrados...</h6>";
	}
