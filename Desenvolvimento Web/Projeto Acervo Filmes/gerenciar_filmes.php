...
<img src="logos.jpg">
	...
	echo verificarMsg();
	?>
<div class="p-2 mb-2 alert alert-danger text-dark text-center rounded">Área dedicada a exclusão e edição de filmes:</div>
	...
	if ($linhas > 0) 
	{
		echo '<h6 class="alert alert-info">Filmes Cadastrados: (Área de Gerenciamento)</h6>';
		...
		while ($registros = mysqli_fetch_assoc($result))
		{
			...
			echo '<a href="deletar.php?id_filme='. $id_filme .'"onclick="return confirm(\'Deseja excluir este contato?\')"class="btn btn-danger">Deletar</a>';
			
			echo '<a href="editar.php?id_filme=' . $id_filme . '"class="btn btn-warning">Editar</a>';
